...
\
\
CELIX_AUTO_START_3=/usr/local/share/celix/bundles/shell.zip /usr/local/share/celix/bundles/remote_shell.zip /home/sandro/Workspace/hometec/bundles/hometec_service/hometec_service.zip\n\
\
\
\
";
